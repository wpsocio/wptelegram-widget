					...
					<Form onSubmit={ handleSubmit }>
						<SectionCard title={ __( 'Common Options' ) }>
							<FormField
								...
								controlProps={ {
									id: 'username',
									type: 'text',
									onBlur: () => values.bot_token && values.username && ! errors.username && ! checkingMemberCount && checkMemberCount( {
						...
						<SectionCard title={ __( 'Google Script' ) }>
							...
							{ values.telegram_blocked === 'yes' && <FormField
								...
								after={ <small><a href="https://gist.github.com/manzoorwanijk/7b1786ad69826d1a7acf20b8be83c5aa#how-to-deploy" target="_blank" rel="noopener noreferrer">{ __( 'See this tutorial' ) }</a></small> }
								controlProps={ {
